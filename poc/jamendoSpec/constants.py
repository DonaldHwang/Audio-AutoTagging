...
class Constants(object):
    ...
    def __init__(self, mode=0):
        ...
        if self.__mode__ == 0:  # Macbook
            ...
            self.MNIST = '/Volumes/scratch/work/falconr1/datasets/'
            self.FashionMNIST = '/Volumes/scratch/work/falconr1/datasets/'
            ...
            self.MNIST = '/scratch/work/falconr1/datasets/'
            ...
            self.MNIST = '/m/cs/work/falconr1/datasets/'
        else:
            print("Mode should be 0, 1, 2, or 3")
            raise Exception("Mode should be 0, 1, 2, or 3")
